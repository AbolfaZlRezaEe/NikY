package com.abproject.niky.utils.internetconnetion
...
import com.abproject.niky.utils.other.Variables.TIMER_SEND_CONNECTION_STATUS
...
class ConnectionLiveData(context: Context) : LiveData<Boolean>() {
    ...
    override fun onActive() {
        ...
        Timer(TIMER_SEND_CONNECTION_STATUS, false).schedule(2000) {
            checkValidNetworks()
        }
    }
